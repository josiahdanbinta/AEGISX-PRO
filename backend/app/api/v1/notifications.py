"""
AEGIS - Notifications API Router
...
async def test_channel(
    ...
    test_entry = NotificationHistory(
        ...
        recipient="test@AEGIS.local",
        subject="Test Notification",
        content="This is a test notification from the AEGIS platform.",
        status="sent",
        triggered_by="test",
    )
    db.add(test_entry)
            ...
            try:
                ...
                async with httpx.AsyncClient(timeout=15.0) as client:
                    ...
                    payload = {
                        ...
                        "title": body.subject or "AEGIS Notification",
                        "text": body.body,
                    }
                    resp = await client.post(webhook_url, json=payload)
