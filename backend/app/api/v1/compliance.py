...
FRAMEWORKS = {
    "pci_dss_v4": {
        ...
        "description": "Payment Card Industry Data Security Standard v4.0 — protecting cardholder data through technical and operational controls.",
        "version": "4.0",
        "category": "regulatory",
        "domains": [
            {
    ...
    "iso27001": {
        ...
        "description": "ISO/IEC 27001:2022 Information Security Management System — internationally recognized standard for information security management.",
        "version": "2022",
        "category": "framework",
        "domains": [
            {
    ...
    "nist_csf": {
        ...
        "description": "NIST Cybersecurity Framework 2.0 — a comprehensive framework for managing and reducing cybersecurity risk.",
        "version": "2.0",
        "category": "framework",
        "domains": [
            {
    ...
    "hipaa": {
        ...
        "abbreviation": "HIPAA",
        "description": "Health Insurance Portability and Accountability Act Security Rule — safeguards for protecting electronic protected health information (ePHI).",
    ...
    "gdpr": {
        ...
        "name": "GDPR",
        "abbreviation": "GDPR",
        "description": "General Data Protection Regulation — EU regulation on data protection and privacy for individuals within the EU/EEA.",
        "version": "2018",
        "category": "regulatory",
        "domains": [
            {
    ...
    "cis_v8": {
        ...
        "description": "Center for Internet Security Critical Security Controls v8 — prioritized set of actions to protect organizations from cyber threats.",
        "version": "8.1",
